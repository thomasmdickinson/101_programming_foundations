...
puts "The total male age is #{total_male_age}."
...
# collection. We would like to be able to operate on those words the same way we
# operate on the elements of an array. Where are the String#each_word and the
...
"The hash has been ruined because the mess_with_demographics method uses code
that mutates the caller."
