...
# code below:
  ...
  def fun_with_ids
    ...
    puts "b_outer is #{b_outer} with an id of: #{b_outer_id} before the block."
                      # the string "forty two"  # a unique object id for that string
    puts "c_outer is #{c_outer} with an id of: #{c_outer_id} before the block."
                      # the array [42]          # a unique object id for that array
    ...
    1.times do
      ...
      # the _outer_id should be unchainged at this point.
      # the _outer.object_id should be the same as the corresponding _outer_id.
      ...
      puts "b_outer inside after reassignment is #{b_outer} with an id of: #{b_outer_id} before and: #{b_outer.object_id} after."
                                                # 'thirty three'           # same as above           # a new object id
      puts "c_outer inside after reassignment is #{c_outer} with an id of: #{c_outer_id} before and: #{c_outer.object_id} after."
                                                 # [44]                    # same as above           # a new object id
      ...
      puts "a_inner is #{a_inner} with an id of: #{a_inner_id} inside the block (compared to #{a_outer.object_id} for outer)."
                       # 22                      # 45                                        # same as a_inner_id
      puts "b_inner is #{b_inner} with an id of: #{b_inner_id} inside the block (compared to #{b_outer.object_id} for outer)."
                       # 'thirty three'          # same as b_outer.object_id                 # same as above
      puts "c_inner is #{c_inner} with an id of: #{c_inner_id} inside the block (compared to #{c_outer.object_id} for outer)."
                       # [44]                    # same as c_outer.object_id                 # same as above
      puts "d_inner is #{d_inner} with an id of: #{d_inner_id} inside the block (compared to #{d_outer.object_id} for outer).\n\n"
                       # 44                      # 89                                        # same as b_inner_id
    end
    ...
    puts "b_outer is #{b_outer} with an id of: #{b_outer_id} BEFORE and: #{b_outer.object_id} AFTER the block."
                     # 'thirty three'      # old outer_id from before the block     # new id established in the block
    puts "c_outer is #{c_outer} with an id of: #{c_outer_id} BEFORE and: #{c_outer.object_id} AFTER the block."
                     # [44]      # old outer_id from before the block     # new id established in the block
    puts "d_outer is #{d_outer} with an id of: #{d_outer_id} BEFORE and: #{d_outer.object_id} AFTER the block.\n\n"
                     # 44                      # 85                       # 89


    # none of this will get printed, it'll all go straight to rescue.
    # this is because the _inner and _inner_id variables were scoped inside the block.
...
# code below:
  ...
  def fun_with_ids
    ...
    # Unlike the block, Tthe method will have done nothing to these variables.
    ...
    # again, this will rescue immediately. It's meaningless outside the context of an_illustrative_method.
...
"The reason for this is because tricky_method is modifying the array, but it is
creating a new string that exists only inside the method."
...
"tricky_method_two does the opposite... it modifies the string, but it creates
a new array that exists only inside the method."
